...
/**
 * Will adjust the compiled output from sass, to match that of
 * node-sass output.
 *
 ...
 * ```
 *
 * @param {String} output css file contents
 * @returns String
 */
Testutils.prototype.adjustOutputForNodeSass = function(output) {
